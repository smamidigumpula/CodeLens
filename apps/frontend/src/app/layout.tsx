...
export const metadata: Metadata = {
  title: "CodeLens | Agentic Dependency Graphs",
  description:
    "CodeLens analyzes GitHub repositories with a LangChain agent and renders interactive dependency graphs through CopilotKit AG-UI.",
};
